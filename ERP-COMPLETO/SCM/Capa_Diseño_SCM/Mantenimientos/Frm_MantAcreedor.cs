...
namespace Capa_Diseño_SCM.Mantenimientos
{
    public partial class Frm_MantAcreedor : Form
    {
        ...
        public Frm_MantAcreedor(String susuario, String permiso)
        {
            InitializeComponent();
            //codigo siguiente 
        ...
        private void btn_Ayuda_Click(object sender, EventArgs e)
        {
            ...
            OdbcDataReader mostrarayuda = logic.consultaayuda("55");
            try
            {
        ...
        private void Frm_MantAcreedor_Load(object sender, EventArgs e)
        {
            this.StartPosition = FormStartPosition.CenterParent;
        }
    }
