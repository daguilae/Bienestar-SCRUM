...
namespace Capa_Diseño_SCM.Mantenimientos
{
    public partial class Frm_MantTipoTransporte : Form
    {
        ...
        string suser;
        string tipopermiso;
        public Frm_MantTipoTransporte(String susuario ,string permiso)
        {
            InitializeComponent();
            //codigo siguiente 
        ...
        {
            Txt_codigotipotransporte.Enabled = false;
        ...
        {
            Txt_codigotipotransporte.Enabled = true;
        ...
        private void btn_Ayuda_Click(object sender, EventArgs e)
        {
            ...
            OdbcDataReader mostrarayuda = logic.consultaayuda("57");
            try
            {
