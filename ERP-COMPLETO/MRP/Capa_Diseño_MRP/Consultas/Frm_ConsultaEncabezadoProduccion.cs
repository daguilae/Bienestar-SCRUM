...
{
    public partial class Frm_ConsultaEncabezadoProduccion : Form
    {
        LAPMRP logic = new LAPMRP();
        public Frm_ConsultaEncabezadoProduccion()
        {
            InitializeComponent();
        ...
        {
            OdbcDataReader mostrar = logic.consultarproduccion();
            try
            {
                while (mostrar.Read())
                {
        ...
        private void Frm_ConsultaEncabezadoProduccion_Load(object sender, EventArgs e)
        {
